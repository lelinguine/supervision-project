...
try {
    ...
    $adminPassword = hash_hmac($_ENV['HASH_ALGO'], $_ENV['ADMIN_PASSWORD'], $_ENV['HASH_SECRET'], false);
    $basicPassword = hash_hmac($_ENV['HASH_ALGO'], $_ENV['BASIC_PASSWORD'], $_ENV['HASH_SECRET'], false);
